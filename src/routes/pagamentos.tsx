  ...
  if (pago) return (
    <div className="min-h-screen bg-white px-5 py-8 text-[#020c42]">
      <div className="mx-auto flex min-h-[82vh] max-w-md flex-col items-center justify-center text-center">
        <div className="flex size-24 items-center justify-center rounded-full bg-emerald-50 ring-1 ring-emerald-200"><CheckCircle2 className="size-14 text-emerald-600" /></div>
        <p className="mt-6 text-[10px] font-black tracking-[0.24em] text-[#0b2be3] uppercase">VanPro · Pagamento aprovado</p>
        <h1 className="mt-2 text-3xl font-black">Reserva confirmada!</h1>
        <p className="mt-3 max-w-xs text-sm leading-relaxed text-slate-500">Pagamento de {brl(valor)} aprovado com sucesso. Sua viagem está confirmada.</p>
        <button onClick={() => navigate({ to: "/reservas" })} className="press mt-8 h-14 w-full rounded-2xl bg-[#0b2be3] font-extrabold text-white shadow-lg">Ver minhas reservas</button>
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-white text-[#020c42]">
      <div className="mx-auto w-full max-w-md pb-10">
        <div className="relative">
          <img src={carrinhoHero.url} alt="Pagamento seguro VanPro" className="block w-full select-none" />
        ...
        <div className="px-5 pt-4">
          <div className="flex items-center justify-between border-b border-slate-200 pb-4">
            <div><p className="text-[10px] font-black tracking-[0.18em] text-[#0b2be3] uppercase">VanPro</p><h1 className="mt-1 text-2xl font-black">Pagamento</h1></div>
            <div className="flex items-center gap-1.5 rounded-full bg-emerald-50 px-3 py-2 text-[10px] font-bold text-emerald-700 ring-1 ring-emerald-200"><LockKeyhole className="size-3.5" /> Compra segura</div>
          </div>

          <section className="mt-4 rounded-3xl border border-slate-200 bg-slate-50 p-4 shadow-sm">
            <div className="flex items-center justify-between"><div><p className="text-[10px] font-bold tracking-wide text-slate-400 uppercase">Resumo da viagem</p><p className="mt-1 text-sm font-extrabold">{reserva.origem} → {reserva.destino}</p></div><ShieldCheck className="size-7 text-[#0b2be3]" /></div>
            <div className="mt-3 grid grid-cols-3 gap-2 text-center"><div className="rounded-xl bg-white p-2 ring-1 ring-slate-100"><span className="block text-[9px] text-slate-400">Horário</span><strong className="text-xs">{reserva.horario}</strong></div><div className="rounded-xl bg-white p-2 ring-1 ring-slate-100"><span className="block text-[9px] text-slate-400">Assentos</span><strong className="text-xs">{reserva.assentos}</strong></div><div className="rounded-xl bg-white p-2 ring-1 ring-slate-100"><span className="block text-[9px] text-slate-400">Passageiros</span><strong className="text-xs">{reserva.passageiros}</strong></div></div>
            <div className="mt-3 flex items-center justify-between border-t border-slate-200 pt-3"><span className="text-xs font-semibold text-slate-500">Total</span><strong className="text-2xl font-black text-[#0b2be3]">{brl(valor)}</strong></div>
          </section>

          <section className="mt-5">
            <div className="flex items-center justify-between"><div><p className="text-[10px] font-bold tracking-[0.16em] text-slate-400 uppercase">Etapa final</p><h2 className="mt-1 text-base font-extrabold">Escolha o pagamento</h2></div><span className="text-[10px] font-semibold text-slate-400">Ambiente protegido</span></div>
          ...
          {metodo !== 'pix' && <section className="mt-4 rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
            <div className="mb-4 flex items-center justify-between"><h3 className="text-sm font-extrabold">Dados do cartão</h3><div className="flex gap-1.5"><span className="rounded-md border border-slate-200 bg-white px-2 py-1 text-[8px] font-black italic text-[#1434CB]">VISA</span><span className="rounded-md border border-slate-200 bg-white px-2 py-1 text-[8px] font-black italic text-[#EB001B]">MASTERCARD</span></div></div>
          ...
          <div className="mt-4 flex items-center justify-center gap-2.5 border-t border-slate-100 pt-4"><span className="rounded-md border border-slate-200 bg-white px-2.5 py-1.5 text-[9px] font-black italic text-[#1434CB]">VISA</span><span className="rounded-md border border-slate-200 bg-white px-2.5 py-1.5 text-[9px] font-black italic text-[#EB001B]">MASTERCARD</span><span className="rounded-md border border-[#32BCAD]/30 bg-[#32BCAD]/10 px-2.5 py-1.5 text-[9px] font-black text-[#159d8f]">PIX</span></div>
