      ...
      <div className="mx-auto min-h-screen max-w-md px-5 pb-8">
        ...
        {metodo !== "pix" && (
          <section className="mt-4 space-y-3 rounded-3xl bg-white/[0.06] p-4 ring-1 ring-white/10">
            ...
            {metodo === "credito" && <select value={cartao.parcelas} onChange={(e) => setCartao((c) => ({ ...c, parcelas: Number(e.target.value) }))} className="w-full rounded-2xl bg-black/20 px-4 py-3.5 text-sm outline-none ring-1 ring-white/10 focus:ring-gold">
