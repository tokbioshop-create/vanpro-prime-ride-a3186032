...
function Pagamentos() {
  ...
  return <div className="min-h-screen bg-white text-[#020c42]"><div className="mx-auto w-full max-w-md pb-10">
    <header className="relative h-[190px] overflow-hidden bg-white"><div className="absolute left-3 top-3 z-20"><button onClick={() => navigate({ to: "/carrinho" })} aria-label="Voltar ao carrinho" className="press flex size-10 items-center justify-center rounded-full bg-white/90 text-[#020c42] shadow-md backdrop-blur-sm ring-1 ring-slate-200"><ArrowLeft className="size-5" /></button></div><img src={carrinhoHero.url} alt="Banner da viagem VanMox" className="absolute left-0 top-0 block w-full max-w-none" /></header>

    <main className="px-5">
      <div className="pt-4"><div className="flex items-start justify-between gap-4"><div><p className="text-[10px] font-black tracking-[0.18em] text-[#0b2be3] uppercase">VanMox</p><h1 className="mt-1 text-2xl font-black tracking-tight text-[#020c42]">Finalizar pagamento</h1></div><Bandeiras /></div></div>
