...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VanPro" },
      { name: "description", content: "Aplicativo de reservas de vans e micro-ônibus executivos." },
...
function RootComponent() {
  ...
  return <QueryClientProvider client={queryClient}><AuthGate /><Toaster /></QueryClientProvider>;
}
